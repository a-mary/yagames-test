...
const winRestartSpan = document.getElementById('win-restart-button');
const congrats = document.getElementById('congrats-h2');
...
function yandexLanguages() {
    ...
    if (ysdk.environment.i18n.lang === "ru") {
        ...
        winRestartSpan.innerHTML = 'Рестарт';
        congrats.innerHTML = 'Молодец! <span class="lvl-complete">Уровень пройден!</span>';

    } else {
        restartSpan.innerHTML = 'Restart';
        movesSpan.innerHTML = 'Moves: ';
        timeSpan.innerHTML = 'Time: ';
        congrats.innerHTML = 'Well done! <span class="lvl-complete">Level complete!</span></span>';
        winRestartSpan.innerHTML = 'Restart';
